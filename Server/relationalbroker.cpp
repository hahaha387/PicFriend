...
RelationalBroker::RelationalBroker()
{
    ...
    sql::SQLString url("jdbc:mariadb://localhost:3306/PicFriend");
...
//        stmnt7->setUInt(1,(unsigned int)idWorker.nextId());
        ...
        stmnt7->setString(3, "/root/PicFriend/Avatar/avatar1.png");
...
//        stmnt7->setUInt(1,(unsigned int)idWorker.nextId());
        ...
        stmnt7->setString(3, "/root/PicFriend/Avatar/avatar2.png");
...
//        stmnt7->setUInt(1,(unsigned int)idWorker.nextId());
        ...
        stmnt7->setString(3, "/root/PicFriend/Avatar/avatar3.png");
...
//        stmnt7->setUInt(1,(unsigned int)idWorker.nextId());
        ...
        stmnt7->setString(3, "/root/PicFriend/Avatar/avatar4.png");
...
//        stmnt6->setUInt(1,(unsigned int)idWorker.nextId());
        stmnt6->setUInt(1,1);
        stmnt6->setString(2, "/root/PicFriend/Picture/picture1.png");
        stmnt6->setUInt(3,1);
        stmnt6->setUInt(4,1);
        stmnt6->execute();
...
//        stmnt6->setUInt(1,(unsigned int)idWorker.nextId());
        stmnt6->setUInt(1,2);
        stmnt6->setString(2, "/root/PicFriend/Picture/picture2.png");
        stmnt6->setUInt(3,1);
        stmnt6->setUInt(4,1);
        stmnt6->execute();
...
//        stmnt6->setUInt(1,(unsigned int)idWorker.nextId());
        stmnt6->setUInt(1,3);
        stmnt6->setString(2, "/root/PicFriend/Picture/picture3.png");
        stmnt6->setUInt(3,1);
        stmnt6->setUInt(4,1);
        stmnt6->execute();
...
//        stmnt6->setUInt(1,(unsigned int)idWorker.nextId());
        stmnt6->setUInt(1,4);
        stmnt6->setString(2, "/root/PicFriend/Picture/picture4.png");
        stmnt6->setUInt(3,1);
        stmnt6->setUInt(4,2);
        stmnt6->execute();
...
//        stmnt6->setUInt(1,(unsigned int)idWorker.nextId());
        stmnt6->setUInt(1,5);
        stmnt6->setString(2, "/root/PicFriend/Picture/picture5.png");
        stmnt6->setUInt(3,1);
        stmnt6->setUInt(4,3);
        stmnt6->execute();
...
//        stmnt6->setUInt(1,(unsigned int)idWorker.nextId());
        stmnt6->setUInt(1,6);
        stmnt6->setString(2, "/root/PicFriend/Picture/picture6.png");
        stmnt6->setUInt(3,1);
        stmnt6->setUInt(4,4);
        stmnt6->execute();
...
//        stmnt6->setUInt(1,(unsigned int)idWorker.nextId());
        stmnt6->setUInt(1,7);
        stmnt6->setString(2, "/root/PicFriend/Picture/picture7.png");
        stmnt6->setUInt(3,1);
        stmnt6->setUInt(4,5);
        stmnt6->execute();
